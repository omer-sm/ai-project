...
model.add(DLLayer("L1", 800, (n,), "relu", "He", 0.01, "adam"))
model.add(DLLayer("L2", 100, (800,), "leaky_relu", "Xavier", 0.01, "adam"))
model.add(DLLayer("L3", 12, (100,), "trim_softmax", "Xavier", 0.01, "adam"))
model.compile("categorical_cross_entropy")
costs = model.train(X_train, Y_train, 75, 600)
